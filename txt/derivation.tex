...
\begin{subequations*}
\begin{align*}
    L_u &= k + 2r + k U_n^m + \frac{a k V_n^m}{1 + \lambda U_n^m}
    \\
    R_u &= 3k - 2r - k U_n^m - \frac{a k V_n^m}{1 + \lambda U_n^m}
    \\
    L_v &= 2k + 2r + \frac{k}{ab} - \frac{a k U_n^m}{b ( 1 + \lambda U_n^m )}
    \\
    R_v &= 2k - 2r - \frac{k}{ab} + \frac{a k U_n^m}{b ( 1 + \lambda U_n^m )}
\end{align}
\end{subequations}
